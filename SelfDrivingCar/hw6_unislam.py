...
def doit2(initial_pos, move1, move2, L0, L1, L2):
    ...
    Omega.value[0][3] += -1.0 / measurement_noise
    Omega.value[3][0] += -1.0 / measurement_noise
    Omega.value[3][3] +=  1.0 / measurement_noise
    Xi.value[0][0] += -L0 / measurement_noise
    Xi.value[3][0] += L0 / measurement_noise
    ...
    Xi.value[0][0] += -move1 / motion_noise
    Xi.value[1][0] += move1 / motion_noise

    #L1 X1
    Omega.value[1][1] +=  1.0 / measurement_noise
    Omega.value[4][1] += -1.0 / measurement_noise
    Omega.value[1][4] += -1.0 / measurement_noise
    Omega.value[4][4] +=  1.0 / measurement_noise
    Xi.value[1][0] += -L1 / measurement_noise
    Xi.value[4][0] += L1 / measurement_noise

    #M1 X1->X2
    Omega.value[1][1] +=  1.0 / motion_noise
    Omega.value[1][2] += -1.0 / motion_noise
    Omega.value[2][1] += -1.0 / motion_noise
    Omega.value[2][2] +=  1.0 / motion_noise
    Xi.value[1][0] += -move2 / motion_noise
    Xi.value[2][0] += move2 / motion_noise

    #L2 X2
    Omega.value[2][2] +=  1.0 / measurement_noise
    Omega.value[2][4] += -1.0 / measurement_noise
    Omega.value[4][2] += -1.0 / measurement_noise
    Omega.value[4][4] +=  1.0 / measurement_noise
    Xi.value[2][0] += -L2 / measurement_noise
    Xi.value[4][0] += L2 / measurement_noise
